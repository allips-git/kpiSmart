...
/**
 * @description 작업(실적) 현황 관리 컨트롤러
 * @author 김민주, @version 1.0, @last date 2022/08/12
 */
class Work_his extends CI_Controller {

    public function __construct() 
	{ 
		parent::__construct();
        $this->allow=array(''); // check login hook
        $this->load->model('st/Work_his_m');
	}
    ...
    public function list()
    {
        ...
        $data['list'] = $this->Work_his_m->get_list($data['var']);
