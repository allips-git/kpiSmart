...
/**
 * @description 카드매출 내역 컨트롤러
 * @author 김원명, @version 1.0
 */
class Card_sales extends CI_Controller {
	...
	public function index()
	{
        ...
        $total_rows = isset($total_json['RESP_DATA']['CARD_SEL_REC']) ? count($total_json['RESP_DATA']['CARD_SEL_REC']) : 0;        
        //$total_rows = count($total_json['RESP_DATA']['CARD_SEL_REC']);
        //print_r($total_rows);
        ...
        //$data['list'] = $json['RESP_DATA']['CARD_SEL_REC'];
        $data['list'] = isset($json['RESP_DATA']['CARD_SEL_REC']) ? $json['RESP_DATA']['CARD_SEL_REC'] : '';        
        $data['params'] = array(
