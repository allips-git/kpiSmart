...
?>
<div class="whouse content wplace">
    <?php // 검색 ?>
                ...
                <dd>
                    <div class="input_line w10">
                        <select id="keyword" name="keyword">
                            <option value="w.wp_nm">작업장명</option>
                            <option value="w.wp_cd">작업장코드</option>
                        </select>
                    </div>
    ...
    <div class="bottom">
        ...
        <div class="input_zone section">
            ...
            <h4>작업장 정보 입력
                ...
                <dl>
                    <dt class="impt">작업장명</dt>
                    <dd>
                        <div class="input_line">
                            <input type="text" class="wp_nm input" name="wp_nm" autocomplete="off" required>
                        </div>
                    </dd>
                </dl>
                <dl>
        ...
        <div class="list_zone section">
            <h2>작업장 리스트</h2>
           <!--  <div class="btns">
                <button type="button" class="btn_line blue">생산라인 관리</button>
            </div> -->
            <div class="list_wrap">
                <div class="n-scroll">
                    <table>
...
<script src="/public/js/food/w_place.js?<?=time();?>"></script>
