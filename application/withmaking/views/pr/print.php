...
<div class="content ord_put work_his">
                ...
                <dd>
                    <div class="input_line w8">
                        <select id="keyword" name="keyword">
                            <option value="m.item_nm">제품명</option>
    ...
    <div class="bottom">
        ...
        <h4 style="width:50%; display: inline-block;">IOT 프린트 데이터 관리</h4>
        <button id ="UpdateCnt" style="display: inline-block; height:30px; width: 6rem; margin:10px; float:right;">실적 완료 </button>
            <div class="h-scroll">
                <table id="" class="hovering at at">
                    <thead>
                        <tr>
                            ...
                            <th class="w5">지시일자</th>
                            <th>제품명</th>
                            <th class="w5">공정 유형</th>
                            <th class="w12">투입공정명</th>
                            <th class="w5">담당자</th>
                            <!-- <th class="w6">목표 실적</th> -->
                            <th class="w6">지시 수량</th>
                            <th class="w6">작업 실적</th>
                            <th class="w5">일 작업시간</th>
                            <th class="w5">투입인원</th>
                            <th class="w5">작업상태</th>
...
<script src="/public/js/food/print.js?<?=time();?>"></script>
<script>
