...
?>
<div class="content job_ord job_reg">
	...
	<div class="section search_zone">
        <h4 class="w100">제조 오더 등록</h4>
        <p class="imptp"><span>*</span> 은 필수 입력 항목입니다.</p>
        <dl class="w25">
            <dt class="impt">제조일자</dt>
            <dd>
                <div class="date_line w120p">
                    <input type="text" id="job_dt" class="datepicker w80 readonly" name="job_dt" onclick="javascript:call_date(this);">
                </div>
            </dd>
        </dl>
        <dl class="w37">
        ...
        <!-- <input type ="hidden" id="wp_uc" name="wp_uc"/> -->
        
        <dl class="w37">
            <dt class="impt">지시 수량</dt>
            <dd>
                <div class="input_line w20">
                    <input type="text" id="job_qty" class="T-right" name="job_qty" value="" Auto numberOnly oninput="calculation();">
                </div>
            </dd>
        </dl>
        <dl class="w25">
            ...
            <dd>
                <div class="input_line w50">
                    <input type="text" id="unit" class="gray" name="unit" Auto disabled>
                </div>
            </dd>
        </dl>
        <dl class="w25">
            ...
            <dd>
                <div class="input_line w50">
                    <input type="text" id="fac_text" name="fac_text" Auto>
                </div>
            </dd>
        </dl>
        <dl class="w37">
        ...
        <dl class="w37">
            ...
            <dd>
                <div class="input_line w40">
                    <input type="text" id="con_nm"  name="con_nm" value="" Auto>
                </div>
            </dd>
        </dl>
	</div>
...
<script src="/public/js/food/job_reg.js?<?=time();?>"></script>
<script>
	$(function() {
