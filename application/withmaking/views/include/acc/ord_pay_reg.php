...
<div class="popup pay_pop ord_pay_reg">
    ...
    <div class="title">수금 등록
        <span class="b-close">&times;</span>
    </div>
    <div class="inner">
        <p class="comment">수금 등록 및 금액 차감 후에는 <span class="sp_title">수정/삭제</span>가 불가하니 신중한 사용 바랍니다.</p>
        <div class="input_zone">
            <div class="input_wrap">
                ...
                <!-- 개발 기간 축소로 기능 비활성화. 김민주 2022/08/09
                <h4 style="margin-top:30px">현재 미수잔액</h4>
                <dl>
                    <dt>미수잔액</dt>
                    <dd>
                        <div class="input_line w40">
                            <input type="text" class="total_amt T-right" autocomplete="off" disabled>
                        </div> &nbsp;&nbsp;원
                    </dd>
                </dl> -->
            </div>
...
<script src="/public/js/food/ord_pay_reg.js?<?=time();?>"></script>
<script>
