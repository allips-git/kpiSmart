...
<div class="popup  pay_pop ord_pay_mod">
    <div class="title">수금수정
        ...
        <div class="input_zone">
            <div class="input_wrap">
                ...
                <dl>
                    ...
                    <dd>
                        <input type="radio" id="chk05" class="chkmod" name="chkmod" value="Y" checked="checked">
                        <label for="chk05">수금</label>
                        <input type="radio" id="chk06" class="chkmod" name="chkmod" value="N">
                        <label for="chk06">금액 차감</label>
                    </dd>
                </dl>
                <dl>
                ...
                <dl>
                    ...
                    <dd>
                        <input type="radio" id="chk07" class="chkboxmod" name="chkboxmod" value="Y" checked="checked">
                        <label for="chk07">포함</label>
                        <input type="radio" id="chk08" class="chkboxmod" name="chkboxmod" value="N">
                        <label for="chk08">별도</label>
                    </dd>
                </dl>
                <dl class="">
                    <dt>비고</dt>
