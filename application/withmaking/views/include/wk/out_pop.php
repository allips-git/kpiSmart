...
<div class="popup out_pop">
    <div class="title">반품 작업 관리
            ...
            <div class="n-scroll">
                <table>
                    <thead>
                        <tr>
                            <th class="w4">
                                <input type="checkbox" id="chk_all02" name="chk_all">
                                <label for="chk_all02"></label>
                            </th>
                            <th class="">제품명</th>
...
$(".out_pop .spin input[type=number]").spinner();
</script>
<script>
	$(function() {
...
<script>
/** 전체 checkbox on/off */
 $('#chk_all02').off().click(function(){
        if($('input:checkbox[id="chk_all02"]').is(':checked') == true){
