<?php // 생산 계획 등록 팝업 페이지 ?>
<div class="plan_reg_pop popup">
    <div class="title">생산 계획 등록
    ...
    <div class="inner">
        <dl class="half">
            <dt>가용여부</dt>
            <dd>
                <input type="radio" id="use01" name="use" checked>
                <label for="use01">사용</label>
                <input type="radio" id="use02" name="use">
                <label for="use02">사용불가</label>
            </dd>
        </dl>
        <dl>
        ...
        <dl class="select_day">
            ...
            <dd>
                <input type="checkbox" id="day08" name="day" checked>
                <label for="day08">월</label>
                <input type="checkbox" id="day09" name="day" checked>
                <label for="day09">화</label>
                <input type="checkbox" id="day10" name="day" checked>
                <label for="day10">수</label>
                <input type="checkbox" id="day11" name="day" checked>
                <label for="day11">목</label>
                <input type="checkbox" id="day12" name="day" checked>
                <label for="day12">금</label>
                <input type="checkbox" id="day13" name="day">
                <label for="day13">토</label>
                <input type="checkbox" id="day14" name="day">
                <label for="day14">일</label>
