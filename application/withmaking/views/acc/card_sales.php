...
<div class="content account card_sales">
    <form>
        <div class="section search_zone">
            ...
            <dd>
                ...
                <input type="hidden" name="s" value="t">
                    ...
                    &nbsp; ~ &nbsp;
                    <div class="date_line w120p">
                        <input type="text" class="datepicker w80" name="enddt" style="width: 85px;" readonly="readonly" value="<?php if(isset($params['enddt'])){ echo $params['enddt']; } ?>">
                    </div>
                    ...
                    <tbody>
                        <?php if ($list != '') { ?>
                            ...
                            <tr>
                                ...
                                <td><?=$row['CARD_CORP_NM'];?></td>
                                <!--<td><?=$row['BZAQ_NM'];?></td>
                                <td><?=$row['BIZ_NO'];?></td>-->
                                <td style="text-align:right"><?=number_format($row['APV_AMT'])."원";?></td>
