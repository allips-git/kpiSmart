    ...
    <div class="bottom">
        <div class="list_zone section">
            ...
            <div class="btns" style="display: none;">
                <?php if($w == "Y") { ?>
                    <button type="button" class="add_pay blue">수금 등록</button>
                <?php } else{ ?>
                    <button type="button" id="d_enroll" class="disable" onclick="alert('권한이 없습니다.');">수금 등록</button>
                <?php } ?>
            </div>
            <div class="list_wrap">
                <div class="">
...
<script src="/public/js/food/ord_pay.js?<?=time();?>"></script>
<script>
