...
<div class="content ord_put prod_his">
    <?php // 검색 ?>
    		...
    		<dl>
    			...
    			<dd>
    				...
    				<div class="input_line w20">
                        <input type="text" id="content" name="content" placeholder="검색어를 입력하세요." auto>
    				</div>
    				<div class="input_line w6">
    					<select id="" name="">
    						<option value="">생산일</option>
    					</select>
    				</div>
                    <div class="date_line w120p">
                        <input type="text" id="start_dt" class="datepicker w80 readonly" name="start_dt" value="" onclick="javascript:call_date(this);" auto>
    				</div>&nbsp;~&nbsp;
                    <div class="date_line w120p">
                        <input type="text" id="end_dt" class="datepicker2 datepick w80 readonly" name="end_dt" value="" onclick="javascript:call_date(this);" auto>
    				</div>
                </dd>
    		</dl>
    	</div>
				...
				<table id="" class="hovering at at">
					<thead>
						<tr>
                            ...
                            <th class="w10">지시 수량</th>
                            <th class="w10">생산 수량</th>
...
<script src="/public/js/food/prod_his.js?<?=time();?>"></script>
<script>
