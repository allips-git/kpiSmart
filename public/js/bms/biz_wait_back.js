    ...
    $.ajax({
        ...
        success: function(data) {
            if(data.msg == "success"){
                ...
                $('#biz_'+p_cen_uc+'').html(a);
                if(data.detail['bizyn'] == "Y"){
                    $('#admin_ikey_'+p_cen_uc+'').html(data.detail['admin_nm']+"("+data.detail['admin_id']+")");
                    $('#admin_dt_'+p_cen_uc+'').html(data.detail['admin_dt']);
                }
                $('#mod_ikey_'+p_cen_uc+'').html(data.detail['mod_nm']+"("+data.detail['mod_id']+")");
                $('#mod_dt_'+p_cen_uc+'').html(data.detail['mod_dt']);
                $('#admin_dt').text(data.detail['admin_dt']);
            }else{
