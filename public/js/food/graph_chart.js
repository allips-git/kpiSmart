...
$(window).on('load',function(){
    ...
    drawLineGraph('#chart-3', chart_1_y, '#graph-3-container', 1);
    drawLineGraph('#chart-4', chart_1_y, '#graph-4-container', 1);
    drawLineGraph('#chart-5', chart_2_y, '#graph-5-container', 2);
    drawLineGraph('#chart-6', chart_1_y, '#graph-6-container', 1);
});
