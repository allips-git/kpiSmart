 ...
 * @author 김민주, @version 1.0, @last date 2022/08/10
 ...
 $(function () {
    ...
    // 검색 - select2 lib 사용
    call_select2('#biz_list', '/base/select2/buyer', 0, '거래처를', '매입거래처_선택'); // 거래처 전체 조회
...
/**
 * @description 매입/지급 리스트 - ajax 페이지네이션
 * @document URL: https://pagination.js.org/docs/index.html
*/
function get_buy_pay_list(obj, mode='') 
{
    const container = $('#pagination');
    $.ajax({

        url: '/acc/buy_pay/list',
        type: 'POST',
        data: obj,
        dataType: "json",
        async: false,
            ...
            container.pagination({ 
                ...
                callback: function (result, pagination) {
                    ...
                    if (count > 0) 
                    {
                        ...
                        {
                            bank = is_empty(list.bank_nm) ? list.bank_nm+' '+list.bl_num+' '+list.acc_nm : '';
