 ...
 function get_pop_detail(obj) 
 {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $(".flaw").val(data.result.detail.re_gb).prop("selected", true);
