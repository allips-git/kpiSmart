...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function renderInnerContent$4(innerProps) { // 2022-05-11 월별달력 타이틀 cnt로 변경
        return (createElement(Fragment, null,
            createElement("div", { className: "fc-daygrid-event-dot", style: { borderColor: innerProps.borderColor || innerProps.backgroundColor } }),
            // innerProps.timeText && (createElement("div", { className: "fc-event-time" }, innerProps.timeText)), // 2022-05-11 월별 달력 시간표시 제거
            createElement("div", { className: "fc-event-title" }, innerProps.event.extendedProps.cnt || createElement(Fragment, null, "\u00A0"))));
    }
    ...
    */
    function transformIsDraggable(val, eventDef, eventUi, context) {
        val = false; // 2022-05-11 월별달력 드래그는 무조건 X
        if (!val) {
