!function (t, e, i) {
    !function () {
        var s,
            ...
            r = ".datepicker-here",
            c = !1,
            d = '<div class="datepicker"><i class="datepicker--pointer"></i><nav class="datepic' +
                    'ker--nav"></nav><div class="datepicker--content"></div></div>',
            l = {
                classes: "",
                inline: !1,
                language: "ru",
            ...
            m = function (t, a) {
                ...
                this.opts.altField && (
                    this.$altField = "string" == typeof this.opts.altField
        ...
        n.prototype = {
            ...
            init: function () {
                ...
                this.opts.onlyTimepicker && this
                    .$datepicker
                    .addClass("-only-timepicker-"),
                this.views[this.currentView] = new e
                    .fn
                    .datepicker
            ...
            _defineLocale: function (t) {
                "string" == typeof t
                    ? (
                        ...
                        this.loc || (console.warn(
                            "Can't find language \"" + t +
            ...
            formatDate: function (t, e) {
                ...
                var i,
                    ...
                    m = "am",
                    p = this._replacer;
                switch (this.opts.timepicker && this.timepicker && u && (
            ...
            selectDate: function (t) {
                ...
                if (t instanceof Date) {
                    ...
                    i.autoClose && !this.timepickerIsActive && (
                        i.multipleDates || i.range
            ...
            _bindVisionEvents: function (t) {
                ...
                this
                    .$datepicker
                    .one("transitionend.dp", t.bind(this, this, !0))
            },
            ...
            _onMouseUpDatepicker: function (t) {
                ...
                t.originalEvent.timepickerFocus || this
                    .$el
                    .focus()
            },
            ...
            _onMouseEnterCell: function (t) {
                ...
                this.focused = s,
                this.silent = !1,
                this.opts.range && 1 == this.selectedDates.length && (
                    this.minRange = this.selectedDates[0],
                    this.maxRange = "",
                    n.less(this.minRange, this.focused) && (this.maxRange = this.minRange, this.minRange = ""),
            ...
            set focused(t) {
                ...
                this.opts.range && 1 == this.selectedDates.length && (
                    this.minRange = this.selectedDates[0],
                    this.maxRange = "",
                    n.less(this.minRange, this._focused) && (this.maxRange = this.minRange, this.minRange = "")
                ),
            ...
            set date(t) {
                return t instanceof Date
                    ? (this.currentDate = t, this.inited && !this.silent && (
            ...
            set view(t) {
                return this.viewIndex = this
                    .viewIndexes
                    .indexOf(t),
                this.viewIndex < 0
                    ? void 0
                    : (this.prevView = this.currentView, this.currentView = t, this.inited && (
                        this.views[t]
        ...
        n.getParsedDate = function (t) {
            return {
                year: t.getFullYear(),
                month: t.getMonth(),
                fullMonth: t.getMonth() + 1 < 10
                    ? "0" + (
                        t.getMonth() + 1
                    )
                    : t.getMonth() + 1,
                date: t.getDate(),
                fullDate: t.getDate() < 10
                    ? "0" + t.getDate()
                    : t.getDate(),
                day: t.getDay(),
                hours: t.getHours(),
                fullHours: t.getHours() < 10
                    ? "0" + t.getHours()
                    : t.getHours(),
                minutes: t.getMinutes(),
                fullMinutes: t.getMinutes() < 10
                    ? "0" + t.getMinutes()
                    : t.getMinutes()
            }
        },
    ...
    function () {
        var t = {
                days: '<div class="datepicker--days datepicker--body"><div class="datepicker--days-na' +
                        'mes"></div><div class="datepicker--cells datepicker--cells-days"></div></div>',
                months: '<div class="datepicker--months datepicker--body"><div class="datepicker--cells' +
                        ' datepicker--cells-months"></div></div>',
                years: '<div class="datepicker--years datepicker--body"><div class="datepicker--cells ' +
                        'datepicker--cells-years"></div></div>'
            },
            s = e.fn.datepicker,
            a = s.Constructor;
        ...
        s.Body.prototype = {
            ...
            _bindEvents: function () {
                this
                    .$el
                    .on("click", ".datepicker--cell", e.proxy(this._onClickCell, this))
            },
            _buildBaseHtml: function () {
            ...
            _getDayNamesHtml: function (t, e, s, a) {
                ...
                a > 7
                    ...
                    : 7 == e
                        ...
                        : (s += '<div class="datepicker--day-name' + (
                            this.d.isWeekend(e)
                                ? " -weekend-"
                                : ""
                        ) + '">' + this.d.loc.daysMin[e] + "</div>", this._getDayNamesHtml(t, ++e, s, ++a))
            },
            _getCellContents: function (t, e) {
                ...
                r.range && (
                    ...
                    1 == n.selectedDates.length && n.focused
                        ...
                        : 2 == n.selectedDates.length && a.bigger(h, t) && a.less(o, t) && (
                            i += " -in-range-"
                        )
                ),
            ...
            _getDayHtml: function (t) {
                ...
                return '<div class="' + e.classes + '" data-date="' + t.getDate() + '" data-mon' +
                        'th="' + t.getMonth() + '" data-year="' + t.getFullYear() + '">' + e.html + "</" +
                        "div>"
            },
            ...
            _getMonthHtml: function (t) {
                ...
                return '<div class="' + e.classes + '" data-month="' + t.getMonth() + '">' + e.html +
                        "</div>"
            },
            ...
            _getYearHtml: function (t) {
                ...
                return '<div class="' + e.classes + '" data-year="' + t.getFullYear() + '">' + e.html +
                        "</div>"
            },
            _renderTypes: {
                days: function () {
    ...
    function () {
        var t = '<div class="datepicker--nav-action" data-action="prev">#{prevHtml}</div><div c' +
                    'lass="datepicker--nav-title">#{title}</div><div class="datepicker--nav-action"' +
                    ' data-action="next">#{nextHtml}</div>',
        ...
        a.Navigation.prototype = {
            ...
            _bindEvents: function () {
                this
                    .d
                    .$nav
                    .on("click", ".datepicker--nav-action", e.proxy(this._onClickNavButton, this)),
                this
                    .d
                    .$nav
                    .on("click", ".datepicker--nav-title", e.proxy(this._onClickNavTitle, this)),
                this
                    .d
                    .$datepicker
                    .on("click", ".datepicker--button", e.proxy(this._onClickNavButton, this))
            },
            _buildBaseHtml: function () {
            ...
            _render: function () {
                ...
                this
                    ...
                    .$nav
                    .html(s),
                "years" == this.d.view && e(".datepicker--nav-title", this.d.$nav).addClass(
                    "-disabled-"
                ),
                this.setNavStatus()
            },
            _getTitle: function (t) {
                return this
                    .d
                    .formatDate(this.opts.navTitles[this.d.view], t)
            },
            _addButton: function (t) {
                ...
                var i = {
                    ...
                    a = n.template(s, i);
                e("[data-action=" + t + "]", this.$buttonsContainer).length || this
                    .$buttonsContainer
                    .append(a)
            },
                ...
                if ((this.opts.minDate || this.opts.maxDate) && this.opts.disableNavWhenOutOfRange) {
                    ...
                    switch (this.d.view) {
                        case "days":
                            this
                                .d
                                ._isInRange(new Date(i, e - 1, 1), "month") || this._disableNav("prev"),
                            this
                                .d
                                ._isInRange(new Date(i, e + 1, 1), "month") || this._disableNav("next");
                            break;
                        case "months":
                            this
                                .d
                                ._isInRange(new Date(i - 1, e, s), "year") || this._disableNav("prev"),
                            this
                                .d
                                ._isInRange(new Date(i + 1, e, s), "year") || this._disableNav("next");
                            break;
                        case "years":
                            var a = n.getDecade(this.d.date);
                            this
                                .d
                                ._isInRange(new Date(a[0] - 1, 0, 1), "year") || this._disableNav("prev"),
                            this
                                .d
                                ._isInRange(new Date(a[1] + 1, 0, 1), "year") || this._disableNav("next")
                    }
                }
            },
    ...
    function () {
        var t = '<div class="datepicker--time"><div class="datepicker--time-current">   <span c' +
                    'lass="datepicker--time-current-hours">#{hourVisible}</span>   <span class="dat' +
                    'epicker--time-current-colon">:</span>   <span class="datepicker--time-current-' +
                    'minutes">#{minValue}</span></div><div class="datepicker--time-sliders">   <div' +
                    ' class="datepicker--time-row">      <input type="range" name="hours" value="#{' +
                    'hourValue}" min="#{hourMin}" max="#{hourMax}" step="#{hourStep}"/>   </div>   ' +
                    '<div class="datepicker--time-row">      <input type="range" name="minutes" val' +
                    'ue="#{minValue}" min="#{minMin}" max="#{minMax}" step="#{minStep}"/>   </div><' +
                    '/div></div>',
            i = e.fn.datepicker,
            s = i.Constructor;
        ...
        i.Timepicker.prototype = {
            init: function () {
                ...
                navigator
                    .userAgent
                    .match(/trident/gi) && (t = "change"),
                this
                    .d
                    .$el
                    .on("selectDate", this._onSelectDate.bind(this)),
                this
                    .$ranges
                    .on(t, this._onChangeRange.bind(this)),
                this
                    .$ranges
                    .on("mouseup", this._onMouseUpRange.bind(this)),
                this
                    .$ranges
                    .on("mousemove focus ", this._onMouseEnterRange.bind(this)),
                this
                    .$ranges
                    .on("mouseout blur", this._onMouseOutRange.bind(this))
            },
            _setTime: function (t) {
                var e = s.getParsedDate(t);
                this._handleDate(t),
                this.hours = e.hours < this.minHours
                    ? this.minHours
                    : e.hours,
                this.minutes = e.minutes < this.minMinutes
                    ? this.minMinutes
                    : e.minutes
            },
            _setMinTimeFromDate: function (t) {
                ...
                this.d.lastSelectedDate && this
                    .d
                    .lastSelectedDate
                    .getHours() > t.getHours() && (this.minMinutes = this.opts.minMinutes)
            },
            _setMaxTimeFromDate: function (t) {
                ...
                this.d.lastSelectedDate && this
                    .d
                    .lastSelectedDate
                    .getHours() < t.getHours() && (this.maxMinutes = this.opts.maxMinutes)
            },
            _setDefaultMinMaxTime: function () {
                var t = 23,
                    e = 59,
                    i = this.opts;
                this.minHours = i.minHours < 0 || i.minHours > t
                    ? 0
                    : i.minHours,
                this.minMinutes = i.minMinutes < 0 || i.minMinutes > e
                    ? 0
                    : i.minMinutes,
                this.maxHours = i.maxHours < 0 || i.maxHours > t
                    ? t
                    : i.maxHours,
                this.maxMinutes = i.maxMinutes < 0 || i.maxMinutes > e
                    ? e
                    : i.maxMinutes
            },
            ...
            _buildHTML: function () {
                ...
                this.d.ampm && (
                    this.$ampm = e('<span class="datepicker--time-current-ampm">').appendTo(e(".datepicker--time-current", this.$timepicker)).html(this.dayPeriod),
            ...
            _handleDate: function (t) {
                ...
                t && (
                    s.isSame(t, this.d.opts.minDate)
                        ...
                        : s.isSame(t, this.d.opts.maxDate) && this._setMaxTimeFromDate(
                            this.d.opts.maxDate
                        )
                ),
            ...
            _onChangeRange: function (t) {
                ...
                this
                    .d
                    ._trigger("timeChange", [this.hours, this.minutes]),
            ...
            _onMouseOutRange: function (t) {
                var i = e(t.target).attr("name");
                this.d.inFocus || e(".datepicker--time-current-" + i, this.$timepicker).removeClass(
                    "-focus-"
                )
            },
